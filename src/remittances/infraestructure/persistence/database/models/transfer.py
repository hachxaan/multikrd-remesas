...
class TransferModel(db.Model):
    ...
    solid_transaction_id = db.Column(db.String,  unique=True, nullable=False)
    ria_transaction_ref = db.Column(db.String,  unique=True, nullable=False)
    destination = db.Column(db.String,  unique=False, nullable=True)

    tx_response = db.Column(db.String,  unique=False, nullable=False)
    code_status = db.Column(db.Integer,  unique=False, nullable=False, default=1)
